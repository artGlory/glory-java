 ...
 * AES对称加密和解密  128位
 *
 * AES可以使用128、192、和256位密钥；本工具用128位分组加密和解密数据，
 */
public class AESTool {
    ...
    public static String AESEncode(String secretKey, String content) {
        try {
            ...
            String AES_encode = byte2hex(byte_AES);
            //11.将字符串返回
            return AES_encode;
    ...
    public static void main(String[] args) {
        String key = "jjfew2323kko23mkdwo";
        ...
        System.out.println("解密后结果:" + AESDecode(key, secret));
    }
}